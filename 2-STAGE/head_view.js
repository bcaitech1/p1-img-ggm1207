...
requirejs(["jquery", "d3"], function ($, d3) {
    ...
    function renderText(svg, text, isLeft, attention, leftPos) {
        ...
        tokenContainer.on("mouseover", function (d, index) {
            ...
            svg.select("#" + id)
                ...
                .selectAll("rect")
                .attr("x", function () {
                    const headIndex = +this.parentNode.getAttribute(
                        "head-index"
                    );
                    return leftPos + boxOffsets(headIndex);
                })
    ...
    function renderAttention(svg, attention) {
        ...
        svg.append("g")
            ...
            .attr("x1", BOXWIDTH)
            .attr("y1", function () {
                const leftTokenIndex = +this.parentNode.getAttribute(
                    "left-token-index"
                );
            ...
            .attr("stroke", function () {
                const headIndex = +this.parentNode.parentNode.getAttribute(
                    "head-index"
                );
    ...
    function drawCheckboxes(top, svg) {
        ...
        function updateCheckboxes() {
            checkboxContainer
                ...
                .data(config.headVis)
                .attr("fill", (d, i) =>
                    d ? headColors(i) : lighten(headColors(i))
                );
        }
